...
func TestScoreToRow(t *testing.T) {
	d := model.DatedScore{
		...
		PlayerScore: model.PlayerScore{
			...
			Win:             true,
			MsName:          "ガンダム",
			MsImageURL:      "https://example.com/gundam.png",
			Score:           150,
			Kills:           3,
			Deaths:          1,
			GiveDamage:      5000,
			ReceiveDamage:   2000,
			ExDamage:        1000,
			MsProficiency:   "master",
			TeamName:        "テストチーム",
			PlayerLevelURL:  "https://example.com/title.png",
			RankBadgeURL:    "https://example.com/badge.png",
			ProfileURL:      "https://web.vsmobile.jp/exvs2ib/profile?param=abc123",
			ShuffleGradeURL: "https://example.com/grade1.png",
			TeamGradeURL:    "https://example.com/grade2.png",
			ScoreRanking:    1,
			ArcadeName:      "テストゲームセンター",
		},
	}
	...
	ds := model.DatedScores{
		{
			...
			Datetime: time.Date(2025, 1, 15, 20, 30, 0, 0, time.UTC),
			PlayerScore: model.PlayerScore{
				City: "東京都", Name: "テスト", Win: true,
				MsName: "ガンダム", MsImageURL: "img.png",
				Score: 100, Kills: 2, Deaths: 1,
				GiveDamage: 3000, ReceiveDamage: 1000, ExDamage: 500,
			},
		},
	}
	...
	ds := model.DatedScores{
		{
			...
			PlayerScore: model.PlayerScore{
				City: "大阪府", Name: "テスト2", Win: false,
				MsName: "ザク", MsImageURL: "img2.png",
				Score: 80, Kills: 1, Deaths: 2,
				GiveDamage: 2000, ReceiveDamage: 3000, ExDamage: 400,
			},
		},
	}
